...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Brouwerij Geel &mdash; Incompatible Browser</title>
...
-->
  ...
  <body class="no-ie">
    ...
    <div>
      ...
      <p>The Brouwerij Geel website only supports modern browsers because it was built with modern techniques which are incompatible with old browsers.</p>
      <p>Perhaps you are using an old Internet Explorer version. For the best experience, we recommend using <a href="https://www.mozilla.org/en-US/firefox/new/">Mozilla Firefox</a> or <a href="https://www.google.com/chrome/">Google Chrome</a>.</p>
    </div>
