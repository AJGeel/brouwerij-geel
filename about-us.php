...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Brouwerij Geel &mdash; Brewing Trouble since 2017.</title>
  ...
  <div class="navbar">
    ...
    <main id="swup" class="swup-transition-main">
      ...
      <div class="masonry-with-columns limit-width">
        ...
        <!-- <h2 style="margin: 6em 0 3em 0; text-align: center; font-family: 'Sen', sans-serif; font-size: 1.6em;">About us page (work-in-progress)</h2>
        <p style="text-align: center; margin-bottom: 6em;">Will contain: who we are, what we do, fun photos of us, and the like.</p>

        <img src="/i/brewing-hero.jpg" alt="our hero"> -->
