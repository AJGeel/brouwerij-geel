...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Brouwerij Geel &mdash; Dry-Hopped Cider Recipe</title>
      ...
      <div class="container">
        ...
        <section class="recipe hero outlined limit-width">
          <div class="hero--left">
            ...
            <p class="publish-date">September 18<sup>th</sup>, 2019</p>
            <h1 class="brew-name">Dry-Hopped Cider</h1>
          ...
          <div class="hero--right">
            <img class="brew-label" src="../i/labels/dry-hopped-cider.jpg" alt="Brew label" onclick="location.href='#recipe'">
          </div>
        </section>
...
<footer>
  <div class="footer-inner limit-width">
    ...
    <style media="screen">
      ...
      :root {
        --royal-gold: hsl(140, 50%, 45%);
        --royal-gold-dark: hsl(140, 33%, 30%);
        --royal-gold-darker: hsl(140, 80%, 10%);
        --royal-gold-light: hsl(140, 100%, 90%);
        --royal-gold-select: hsla(140, 28%, 70%, .2);
        --royal-gold-sand: hsl(140, 5%, 99%);
      }
