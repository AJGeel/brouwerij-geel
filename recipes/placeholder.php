...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Brouwerij Geel &mdash; Placeholder Recipe</title>
      ...
      <div class="container">
        ...
        <section class="recipe hero outlined limit-width">
          <div class="hero--left">
            ...
            <h1 class="brew-name">Place&mdash;Holder</h1>
        ...
        <article class="recipe limit-width" id="recipe">
          <section class="ingredients outlined">
            ...
            <ul>
              <li><span class="amount">750</span> g Lorem Malt</li>
              <li><span class="amount">250</span> g Ipsum Malt</li>
            </ul>
