...
<footer>
  <div class="footer-inner limit-width">
    ...
    box-shadow:0 0 2px hsla(26,80%,60%,0)
}
button.call-to-action:focus,button.call-to-action:hover{
    box-shadow:0 0 10px hsla(26,80%,60%,.5),0 0 30px hsla(26,80%,60%,.25)
}
nav .navbar{
    box-shadow:0 1px 1px hsla(26,20%,60%,.08),0 2px 2px hsla(26,20%,60%,.12),0 4px 4px hsla(26,20%,60%,.16),0 8px 8px hsla(26,20%,60%,.2)
}
footer .social:hover{
    box-shadow:0 0 10px hsla(26,80%,60%,.5),0 0 30px hsla(26,80%,60%,.25)
}
...
.hero .brew-label:hover{
    box-shadow:0 2px 2px hsla(26,20%,60%,.06),0 4px 4px hsla(26,20%,60%,.08),0 8px 8px hsla(26,20%,60%,.12),0 16px 16px hsla(26,20%,60%,.16)
}
