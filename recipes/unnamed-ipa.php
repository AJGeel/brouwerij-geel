...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Brouwerij Geel &mdash; Unnamed IPA Recipe</title>
    ...
    <style>
      html {
        cursor: url(data:image/png;base64,),auto;
      }
    </style>
  ...
  <body>
      ...
      <div class="container">
        ...
        <article class="recipe limit-width" id="recipe">
          <section class="ingredients outlined">
            ...
            <ul>
              <li><span class="amount">800</span> g Palemout</li>
              <li><span class="amount">90</span> g CaraMunich® type I</li>
            </ul>

            <h3>Hops &amp; Aromatics</h3>
            <ul>
              <li><span class="amount">14</span> g Citra Hops (15% AA)</li>
              <li><span class="amount">7</span> g Cascade Hops (7% AA)</li>
              <li><span class="amount">1</span> lemon(s) worth of rind and juice</li>
            </ul>

            <h3>Yeast</h3>
            <ul>
              <li>Fermentis SafAle US-05</li>
            </ul>
          ...
          <section class="instructions">
            ...
            <div class="phase" id="mash">
              ...
              <ul>
                <li>Fill your brewing kettle with <span class="amount">3</span> liters of water, and heat it to 66&deg;C.</li>
                <li>Mill the grains, and add them to your mash bag in the kettle.</li>
                <li>Keep the mash for 40 minutes at 65&deg;C. Remember to stir every 10 minutes, and take regular readings with your thermometer.</li>
                <li>Then, slowly increase the temperature. Keep the mash at 72&deg;C for 20 minutes.</li>
                <li>Finally, increase to 78&deg;C for 5 minutes.</li>
                <li>Prepare for <i>The Sparge</i> by heating another <span class="amount">5</span> liters of water to 77&deg;C.</li>
              </ul>
            </div>
            ...
            <div class="phase" id="sparge">
              ...
              <ul>
                ...
                <li>Slowly and evenly pour the <span class="amount">5</span> liters of water you heated over the <i>Mash Bag</i> to extract the <i>Wort</i>.</li>
                <li>Sparge until a total of <span class="amount">8</span> liters of wort is collected.</li>
              </ul>
            </div>
            ...
            <div class="phase" id="boil">
              ...
              <ul>
                ...
                <li>Slightly reduce the heat, and stir occasionally. Start your timer for <i>75 minutes</i>, and add your <i>Hops and/or Aromatics</i> at these times:</li>
                <li>Add <i>half</i> (&#189;) of your hops, <i>15 minutes into the Boil</i>.</li>
                <li>Add <i>a quarter</i> (&#188;) of your hops, <i>45 minutes into the Boil</i>.</li>
                <li>Add <i>a quarter</i> (&#188;) of your hops, <i>5 minutes before Flameout</i>.</li>
    ...
    <style media="screen">
      ...
      :root {
        --royal-gold: hsl(50, 80%, 46%);
        --royal-gold-dark: hsl(115, 50%, 20%);
        --royal-gold-darker: hsl(115, 50%, 10%);
        --royal-gold-light: hsl(50, 100%, 90%);
        --royal-gold-select: hsla(50, 48%, 60%, .2);
        --royal-gold-sand: hsl(50, 18%, 96%);
        --royal-green: hsl(115, 30%, 20%);
      }

      /* Pesky box-shadow overrides: Use autocompleter for this 'hsla(50' -> 'hsla(NEW)'. */
      button.call-to-action{box-shadow:0 0 2px hsla(50,80%,60%,0)}button.call-to-action:focus,button.call-to-action:hover{box-shadow:0 0 10px hsla(50,80%,60%,.5),0 0 30px hsla(50,80%,60%,.25)}nav{box-shadow:0 1px 1px hsla(50,20%,60%,.08),0 2px 2px hsla(50,20%,60%,.12),0 4px 4px hsla(50,20%,60%,.16),0 8px 8px hsla(50,20%,60%,.2)}nav .navbar svg{box-shadow:0 1px 1px hsla(50,20%,60%,.08),0 2px 2px hsla(50,20%,60%,.12),0 4px 4px hsla(50,20%,60%,.16),0 8px 8px hsla(50,20%,60%,.2)}nav .navbar svg:hover{box-shadow:0 1px 2px hsla(50,20%,60%,.16),0 2px 4px hsla(50,20%,60%,.24),0 4px 8px hsla(50,20%,60%,.32),0 8px 16px hsla(50,20%,60%,.4)}footer .social:hover{box-shadow:0 0 10px hsla(50,80%,60%,.5),0 0 30px hsla(50,80%,60%,.25)}.brew-label{box-shadow:0 1px 1px hsla(50,20%,60%,.08),0 2px 2px hsla(50,20%,60%,.12),0 4px 4px hsla(50,20%,60%,.16),0 8px 8px hsla(50,20%,60%,.2)}.hero .brew-label:hover{box-shadow:0 2px 2px hsla(50,20%,60%,.06),0 4px 4px hsla(50,20%,60%,.08),0 8px 8px hsla(50,20%,60%,.12),0 16px 16px hsla(50,20%,60%,.16)}.other-brews .carrousel .carrousel--cell:hover .brew-label{box-shadow:0 2px 2px hsla(50,20%,60%,.06),0 4px 4px hsla(50,20%,60%,.08),0 8px 8px hsla(50,20%,60%,.12),0 16px 16px hsla(50,20%,60%,.16)}
    </style>
